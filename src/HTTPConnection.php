...
class HTTPConnection extends AbstractHttp
{
     ...
     *
     * @see \Sostheblack\Http\HTTPConnection::clearHeaders()
     * @see \Sostheblack\Http\HTTPConnection::clearParameters()
     */
     ...
     *
     * @return \Sostheblack\Http\CookieManager
     */
     ...
     *
     * @return \Sostheblack\Http\HTTPRequest
     */
     ...
     *
     * @param \Sostheblack\Http\HTTPAuthenticator $httpAuthenticator
     */
     ...
     *
     * @param \Sostheblack\Http\CookieManager $cookieManager
     */
